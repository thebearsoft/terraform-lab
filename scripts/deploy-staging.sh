...
# This script deploys all layers in the correct order for staging
...
echo ""
echo "Next steps:"
echo "1. Configure kubectl: gcloud container clusters get-credentials bearsoft-staging-gke --region us-central1"
